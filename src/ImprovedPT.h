 ...
 * ImprovedPT
 *
 * Improved redshift-space PT predictions from
 *   Taruya, Nishimichi, & Saito, "Baryon Acoustic Oscillations in 2D: Modeling
 *   Redshift-space Power Spectrum from Perturbation Theory", arXiv:1006.0699 .
 *
 ******************************************************************************/
class ImprovedPT {
public:
    ImprovedPT(const Cosmology& C, const PowerSpectrum& P_i, real z_i, real z, int Neta, int Nk = 1000, real kcut = 10.);
    ~ImprovedPT();
