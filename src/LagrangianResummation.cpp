...
real LagrangianResummation::P22(real k) const {
    ...
    return V * Integrate<2>(bind(f_22, cref(P_L), k, _1, _2), a, b, epsrel, epsrel*P_L(k)/V);
}
...
real LagrangianResummation::P13(real k) const {
    ...
    return V * P_L(k) * Integrate(bind(f_13, cref(P_L), k, _1), a, b, epsrel, epsrel/V);
}
...
real LagrangianResummation::Ps(real k, real mu) const {
    ...
    real a[2] = { QMIN, -1 };
    real b[2] = { QMAX, XMAX };
    real B1 = V*Integrate<2>(bind(f1_22, cref(P_L), k, _1, _2), a, b, epsrel, epsrel*P/V);
    real B2 = V*Integrate<2>(bind(f2_22, cref(P_L), k, _1, _2), a, b, epsrel, epsrel*P/V);
    real B3 = V*Integrate<2>(bind(f3_22, cref(P_L), k, _1, _2), a, b, epsrel, epsrel*P/V);
    real B4 = V*Integrate<2>(bind(f4_22, cref(P_L), k, _1, _2), a, b, epsrel, epsrel*P/V);
    real C1 = V*Integrate<ExpSub>(bind(f1_13, cref(P_L), k, _1), QMIN, QMAX, epsrel, epsrel/V);
    real C2 = V*Integrate<ExpSub>(bind(f2_13, cref(P_L), k, _1), QMIN, QMAX, epsrel, epsrel/V);
